...
<body>
    <div class="container">
        <h4 class="mb-3 mt-5">Tambah paket data</h4>
        <form action="/tambah-data" method="POST" class="form">
            @csrf
            ...
            <div class="form-group mb-3">
                <label for="jumlah">Jumlah data (MB)</label>
                <input type="number" class="form-control" id="jumlah" placeholder="Jumlah data" name="jumlah_data">
            </div>
