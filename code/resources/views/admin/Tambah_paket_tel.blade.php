...
<body>
    <div class="container">
        <h4 class="mb-3 mt-5">Tambah paket telepon</h4>
        <form action="/tambah-tel" method="POST" class="form">
            @csrf
            ...
            <div class="form-group mb-3">
                <label for="jumlah">Jumlah menit</label>
                <input type="number" class="form-control" id="jumlah" placeholder="Jumlah data" name="jumlah_menit">
            </div>
